...
export function buildSeoRegistry(): SeoRegistryEntry[] {
  ...
  out.push(entry({ path: "/vs", title: "Compare Flap | Flap", description: "Compare Flap with Google Workspace, Microsoft 365, Hydra, Folio, Zoho, and more.", h1: "Compare Flap", pageType: "collection", indexable: true, sitemap: true, modified: SITE_MODIFIED }));
  out.push(entry({ path: "/research", title: "Business email cost research | Flap", description: "2026 cost table for founders comparing suite pricing with Flap's multi-domain plans.", h1: "Business email cost, 2026", pageType: "product", indexable: true, sitemap: true, modified: SITE_MODIFIED }));
