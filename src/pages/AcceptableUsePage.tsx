      ...
      <article className="mx-auto max-w-3xl px-5 pb-24 pt-10 md:px-8 md:pt-14">
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-[var(--muted)]">
            Flap processes delivery, bounce, and complaint feedback and may suppress recipients or restrict abusive
            senders.
          </p>
        </section>
        <section className="mt-10">
          ...
          <p className="mt-2 text-[var(--muted)]">
            ...
            provider reputation. Sending limits depend on your plan and account status.
          </p>
          <p className="mt-3 text-[var(--muted)]">
            Users are responsible for having a lawful and appropriate basis to contact recipients.
          </p>
        </section>
