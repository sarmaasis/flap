...
1. Apply D1 migrations: `npm run db:migrate:remote` (see `migrations/README.md` — **0005_billing** required for plans).
2. Set Worker secrets (see `.dev.vars.example`):
   ...
   - Product IDs: `DODO_PRODUCT_STARTER`, `DODO_PRODUCT_PRO`, `DODO_PRODUCT_BUSINESS`
